...
1. **関連法令の特定**
   - search_law または resolve_law でテーマに関連する法令候補を確認
   - 該当する法令の law_id を確定

2. **根拠条文の取得**
   - get_article で確定済み law_id の関連条文を取得
...
1. **安衛法の根拠条文**
   - resolve_law で「安衛法」を解決し、get_article で関連条文を取得
   - 必要に応じて「安衛令」「安衛則」も resolve_law 後に確認
